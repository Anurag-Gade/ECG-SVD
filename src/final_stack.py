...
Original file is located at
    https://colab.research.google.com/drive/1rtnyVI1i6eV-GCfAA0ZNUApJCvky4LZp
"""
...
class Stack_Model:
    ...
    def fit_split_model(self, X_img_train, X_SVD_train, y_train, X_img_val, X_SVD_val, y_val, epochs, batch_size):
        ...
        X_tr_ch2, X_val_ch2 = np.repeat(X_SVD_train[:,:,:,2, np.newaxis], 3, -1), np.repeat(X_SVD_val[:,:,:,2, np.newaxis], 3, -1)
        X_tr_ch3, X_val_ch3 = np.repeat(X_SVD_train[:,:,:,3, np.newaxis], 3, -1), np.repeat(X_SVD_val[:,:,:,3, np.newaxis], 3, -1)
        X_tr_ch4, X_val_ch4 = np.repeat(X_SVD_train[:,:,:,4, np.newaxis], 3, -1), np.repeat(X_SVD_val[:,:,:,4, np.newaxis], 3, -1)
        ...
        self.hist_split = self.model.fit(
            [X_img_train, X_tr_ch0, X_tr_ch1, X_tr_ch2, X_tr_ch3, X_tr_ch4], y_train,
            epochs=epochs, 
            batch_size = batch_size,
            validation_data=([X_img_val, X_val_ch0, X_val_ch1, X_val_ch2, X_val_ch3, X_val_ch4], y_val),
    ...
    def evaluate_split_model(self, X_image_test, X_SVD_test, y):
        ...
        X_test_ch3 = np.repeat(X_SVD_test[:,:,:,3, np.newaxis], 3, -1)
        X_test_ch4 = np.repeat(X_SVD_test[:,:,:,4, np.newaxis], 3, -1)
        self.yprobs = self.model.predict([X_image_test, X_test_ch0, X_test_ch1, X_test_ch2, X_test_ch3, X_test_ch4])
    ...
    def fit_kfold_model(self, X_image_train, y_image_train, cv, epochs, batch_size):
        ...
        for fold_num, (train_index, val_index) in enumerate(skf.split(X_image_train, y_image_train)):
          ...
          hist_kfold = self.model.fit(
            x= [X_tr_img, X_tr_ch0, X_tr_ch1, X_tr_ch2, X_tr_ch3, X_tr_ch4], 
            y = y_train,
            epochs=epochs, 
            batch_size = batch_size,
            validation_data=([X_val_img, X_val_ch0, X_val_ch1, X_val_ch2, X_val_ch3, X_val_ch4], y_val),
            callbacks = [self.model_checkpoint, self.early_stopping]
          )

          self.model.load_weights(self.kfold_weights[fold_num])
          yprobs_val = self.model.predict([X_val_img, X_val_ch0, X_val_ch1, X_val_ch2, X_val_ch3, X_val_ch4])
          ...
          if fold_num==0:
              ...
              plt.title('Loss Plot')
              plt.savefig('../misc/final_stack/model2/kfold/stack_loss_plot'+('_%d' %(run_number))+'.eps', format='eps')
              plt.savefig('../misc/final_stack/model2/kfold/stack_loss_plot'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)
              ...
              plt.savefig('../misc/final_stack/model2/kfold/stack_acc_plot'+('_%d' %(run_number))+'.eps', format='eps')
              plt.savefig('../misc/final_stack/model2/kfold/stack_acc_plot'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)
    ...
    def evaluate_test_set(self):
        ...
        self.test_probs = self.model.predict([X_image_test, X_test_ch0, X_test_ch1, X_test_ch2, X_test_ch3, X_test_ch4])
    ...
    def make_loss_plot(self,run_number,kfold=True):
      if kfold:
        ...
        plt.ylabel('Cross Entropy Loss')
        plt.title('Loss Plot')
        plt.savefig('../misc/demoofstack/model1/kfold/stack_loss_plot'+('_%d' %(run_number))+'.eps', format='eps')
        plt.savefig('../misc/demoofstack/model1/kfold/stack_loss_plot'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)
      else:
        ...
        plt.ylabel('Cross Entropy Loss')
        plt.title('Loss Plot')
        plt.savefig('../misc/final_stack/model2/split/stack_loss_plot_split'+('_%d' %(run_number))+'.eps', format='eps')
        plt.savefig('../misc/final_stack/model2/split/stack_loss_plot_split'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)
    ...
    def make_acc_plot(self,run_number,kfold=True):
      if kfold:
        ...
        plt.ylabel('Accuracy')
        plt.title('Accuracy Plot')
        plt.savefig('../misc/demoofstack/model1/kfold/stack_acc_plot'+('_%d' %(run_number))+'.eps', format='eps')
        plt.savefig('../misc/demoofstack/model1/kfold/stack_acc_plot'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)
      else:
        ...
        plt.ylabel('Accuracy')
        plt.title('Accuracy Plot')
        plt.savefig('../misc/final_stack/model2/split/stack_acc_plot_split'+('_%d' %(run_number))+'.eps', format='eps')
        plt.savefig('../misc/final_stack/model2/split/stack_acc_plot_split'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)
    ...
    def save_confusion_matrix(self,run_number,kfold=True):
      if kfold==True:
        ...
        plt.savefig('../misc/final_stack/model2/kfold/stack_cm'+('_%d' %(run_number))+'.eps', format='eps')
        plt.savefig('../misc/final_stack/model2/kfold/stack_cm'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)
      else:
        ...
        plt.xlabel('Predicted Class Label')
        plt.ylabel('Actual Class Label')
        plt.savefig('../misc/final_stack/model2/split/stack_cm_split'+('_%d' %(run_number))+'.eps', format='eps')
        plt.savefig('../misc/final_stack/model2/split/stack_cm_split'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)

stack_model_summary = Stack_Model('test', 'test2')
Stack_Model.build_effnet_model()

losses, accs, precs, recs, f1s, specificities, cohen_kappas = [], [], [], [], [], [], []
for run_number in tqdm(range(5)):
  print('Run number: %d' %(run_number+1))
  stack_model = Stack_Model('../model_weights/final_stack/model2/', 'model2')
...
for run_number in tqdm(range(5)):
  print('Run number: %d' %(run_number+1))
  stack_model_split = Stack_Model('../model_weights/demoofstack/model1/', 'model1_split')
