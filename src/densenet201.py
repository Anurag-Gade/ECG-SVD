...
Original file is located at
    https://colab.research.google.com/drive/1v76LUeaI4e9sRtXddmmRpDv9_d-6O4st
"""
...
class DenseNet201_Model:
    def __init__(self, output_dir, num_classes=3, verbose=1):
        ...
        self.best_hist = None
        self.kfold_f1_weights = os.path.join(self.output_dir, 'kfold', 'densenet201_f1.h5')
        self.kfold_f2_weights = os.path.join(self.output_dir,'kfold', 'densenet201_f2.h5')
        self.kfold_f3_weights = os.path.join(self.output_dir, 'kfold', 'densenet201_f3.h5')
        self.kfold_f4_weights = os.path.join(self.output_dir, 'kfold', 'densenet201_f4.h5')
        self.kfold_f5_weights = os.path.join(self.output_dir, 'kfold', 'densenet201_f5.h5')
        self.split_weights_path = os.path.join(self.output_dir, 'split', 'densenet201_split.h5')
