...
Original file is located at
    https://colab.research.google.com/drive/1IsS7tN2VfiF6cyNOYX_jJiLbaEvEcH60
"""
...
class NASNetMobile_Model:
    def __init__(self, output_dir, num_classes=3, verbose=1):
        """
        ...
        self.model = self.build_nasnet_model()
        self.best_fold = 0
        self.best_fold_loss = 0
        self.best_hist = None
        self.kfold_f1_weights = os.path.join(self.output_dir, 'kfold', 'nasnetmobile_f1.h5')
        self.kfold_f2_weights = os.path.join(self.output_dir,'kfold', 'nasnetmobile_f2.h5')
        self.kfold_f3_weights = os.path.join(self.output_dir, 'kfold', 'nasnetmobile_f3.h5')
        self.kfold_f4_weights = os.path.join(self.output_dir, 'kfold', 'nasnetmobile_f4.h5')
        self.kfold_f5_weights = os.path.join(self.output_dir, 'kfold', 'nasnetmobile_f5.h5')
        self.split_weights_path = os.path.join(self.output_dir, 'split', 'nasnetmobile_split.h5')
    ...
    def build_nasnet_model(self):
        """
            Build the NASNetMobile  model
        """
        inputs = layers.Input(shape=(128, 128, 3))
        model = NASNetMobile(include_top=False, input_tensor=inputs, weights="imagenet")
        ...
        # Compile
        model = tf.keras.Model(inputs, outputs, name="NASNet")
    ...
    def make_loss_plot(self,run_number,kfold=True):
      if kfold:
        ...
        plt.title('Loss Plot')
        plt.savefig('../misc/nasnetmobile/kfold/nasnetmobile_loss_plot'+('_%d' %(run_number))+'.eps', format='eps')
        plt.savefig('../misc/nasnetmobile/kfold/nasnetmobile_loss_plot'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)
      else:
        ...
        plt.ylabel('Cross Entropy Loss')
        plt.title('Loss Plot')
        plt.savefig('../misc/nasnetmobile/split/nasnetmobile_loss_plot_split'+('_%d' %(run_number))+'.eps', format='eps')
        plt.savefig('../misc/nasnetmobile/split/nasnetmobile_loss_plot_split'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)
    ...
    def make_acc_plot(self,run_number,kfold=True):
      if kfold:
        ...
        plt.savefig('../misc/nasnetmobile/kfold/nasnetmobile_acc_plot'+('_%d' %(run_number))+'.eps', format='eps')
        plt.savefig('../misc/nasnetmobile/kfold/nasnetmobile_acc_plot'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)
      else:
        ...
        plt.ylabel('Accuracy')
        plt.title('Accuracy Plot')
        plt.savefig('../misc/nasnetmobile/split/nasnetmobile_acc_plot_split'+('_%d' %(run_number))+'.eps', format='eps')
        plt.savefig('../misc/nasnetmobile/split/nasnetmobile_acc_plot_split'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)
    ...
    def save_confusion_matrix(self,run_number,kfold=True,y_true=None):
      if kfold==True:
        ...
        plt.savefig('../misc/nasnetmobile/kfold/nasnetmobile_cm'+('_%d' %(run_number))+'.eps', format='eps')
        plt.savefig('../misc/nasnetmobile/kfold/nasnetmobile_cm'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)
      else:
        ...
        plt.xlabel('Predicted Class Label')
        plt.ylabel('Actual Class Label')
        plt.savefig('../misc/nasnetmobile/split/nasnetmobile_cm_split'+('_%d' %(run_number))+'.eps', format='eps')
        plt.savefig('../misc/nasnetmobile/split/nasnetmobile_cm_split'+('_%d' %(run_number))+'.jpg', format='jpg', dpi=300)
...
for i in tqdm(range(5)):
  nasnetmobile_model = NASNetMobile_Model(output_dir='../model_weights/nasnetmobile')
  nasnetmobile_model.fit_kfold_model(X_train, y_train, skf, 10000, 16, i+1)
  log_loss, accuracy, precision, recall, f1, specificity, kappa = nasnetmobile_model.evaluate_test_set(X_test, y_test)
  ...
  nasnetmobile_model.save_confusion_matrix(i+1, kfold=True, y_true=y_test)
  del nasnetmobile_model
...
for i in tqdm(range(5)):
  ...
  nasnetmobile_model_split = NASNetMobile_Model(output_dir='../model_weights/nasnetmobile')
  nasnetmobile_model_split.fit_split_model(X_train, y_train, X_val, y_val, 10000, 16)

  log_loss, accuracy, precision, recall, f1, specificity, kappa = nasnetmobile_model_split.evaluate_split_model(X_test, y_test)
  ...
  nasnetmobile_model_split.make_loss_plot(i+1,kfold=False)
  nasnetmobile_model_split.make_acc_plot(i+1,kfold=False)
  nasnetmobile_model_split.save_confusion_matrix(i+1, kfold=False, y_true=y_test)
  del nasnetmobile_model_split
